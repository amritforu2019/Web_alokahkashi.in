          ...
          <div class="col-xs-12">
            <div class="clearfix">
              <div class="pull-right tableTools-container"> </div>
                ...
                <?php
				$i=1; 
				$qry=mysqli_query($DB_LINK,"select * from tbl_jobs where typ='job' order by id desc");
				foreach($qry as $row)
				{  
                    ...
                    <tr class="table-activity">
                      <td><?php echo $i;?></td>
                      <td><strong><?php echo data_cutter($row['title'],50); ?></strong><br>
                      ...
                      <div class="tools action-buttons"> <a href="job_edit?edit=<?php echo $row['id'];?>" title="Edit" class="blue"><i class="ace-icon fa fa-pencil bigger-125"></i></a>
                       ...
                       <?php if($row['status']==1){ ?>
                        ...
                        <?php }?>
                       <a class="red"onClick="return del(<?php echo $row['id'];?>, 'job_list')"> <i class="ace-icon fa fa-times bigger-125" title="Delete"></i> </a> 
                       </div>
                      </td>
                      ...
                      <td><?php echo  date('d/m/y', strtotime($row['autodate'])).'<br>';$time_ago=$row['autodate'];$time_elapsed = timeAgo($time_ago);?></td>
					   ...
					   if($row['imp']==0) 
					   { 
					   echo '<a href="job_list.php?imp_yes='.$row['id'].'" class="red"><strong>NO</strong></a>'; 
					   } 
					   else 
					   if($row['imp']==1) 
					   { 
					   echo '<a href="job_list.php?imp_no='.$row['id'].'" class="green"><strong>YES</strong></a>'; 
					   } 
					    ?></td>
