...
if(isset($_POST['submit']))
{
	...
	$dup_entry=mysqli_num_rows(mysqli_query($DB_LINK,"select * from tbl_jobs where title='".$_POST['title']."-trainees'"));
     ...
     if (isset($_FILES['uploaded_file'])) 
    {
		...
		$url = strtolower(clean($_POST['title']).'-trainees.html'); 
...
<meta charset="utf-8" />
<title>Trainees Jobs Add :: <?php echo $SITE_NAME;?></title>
    ...
    <div class="main-content-inner">
      <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li class="active">Add New Trainees Job</li>
        </ul>
        <!-- /.breadcrumb -- -->
      </div>
      <div class="page-content">
        <div class="page-header">
          <h1> Add New Trainees Job </h1>
        </div>
        <!-- /.page-header -->
        <div class="row">
          <div class="col-xs-12">
