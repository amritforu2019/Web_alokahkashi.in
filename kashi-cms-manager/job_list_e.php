...
<meta charset="utf-8" />
<title>Empanelment Jobs List :: <?php echo $SITE_NAME;?></title>
    ...
    <div class="main-content-inner">
      <div class="breadcrumbs ace-save-state" id="breadcrumbs">
        <ul class="breadcrumb">
          ...
          <li class="active">Empanelment Jobs List</li>
        </ul>
        <!-- /.breadcrumb -->
      </div>
          ...
          <div class="col-xs-12">
            <div class="clearfix">
              <div class="pull-right tableTools-container"> </div>
                ...
                <?php
				$i=1; 
				$qry=mysqli_query($DB_LINK,"select * from tbl_jobs where typ='emp' order by id desc");
				foreach($qry as $row)
				{  
                    ...
                    <tr class="table-activity">
                      ...
                      <div class="tools action-buttons"> <a href="job_edit_e?edit=<?php echo $row['id'];?>" title="Edit" class="blue"><i class="ace-icon fa fa-pencil bigger-125"></i></a>
                       
                       <?php if($row['status']==1){ ?>
                        <a href="job_list_e?ban=<?php echo $row['id'];?>"  id="bandiv"><i class="fa fa-ban fa-lg" style="color:green" title="Ban"></i></a>
                        <?php } else  { ?>
                        <a href="job_list_e?unban=<?php echo $row['id'];?>"  id="bandiv"><i class="fa fa-ban fa-lg" style="color:red" title="Unban"></i></a>
                        <?php }?>
                       <a class="red" onClick="return del(<?php echo $row['id'];?>, 'job_list_e')"> <i class="ace-icon fa fa-times bigger-125" title="Delete"></i> </a> 
                       </div>
                      </td>
                      ...
                      <td><?php echo  date('d/m/y', strtotime($row['autodate'])).'<br>';$time_ago=$row['autodate'];$time_elapsed = timeAgo($time_ago);?></td>
					   ...
					   if($row['imp']==0) 
					   { 
					   echo '<a href="job_list_e.php?imp_yes='.$row['id'].'" class="red"><strong>NO</strong></a>'; 
					   } 
					   else 
					   if($row['imp']==1) 
					   { 
					   echo '<a href="job_list_e.php?imp_no='.$row['id'].'" class="green"><strong>YES</strong></a>'; 
					   } 
					    ?></td>
