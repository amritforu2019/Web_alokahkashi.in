...
if(isset($_POST['submit']))
{
 ...
 if (isset($_FILES['image']))
 {
  ...
  $stmt = $PDO_LINK->prepare("
        INSERT INTO tbl_amenities_icons (project_id,image,image_url,icon_name)
        VALUES (:project_id, :image,:image_url,:icon_name)
    ");
...
try {
 ...
 header("location:amenities_icons_list?project_id=".$project_id);
 exit;
          ...
          <div class="col-xs-12">
            ...
            <form class="form-horizontal" role="form" method="post" action="" enctype="multipart/form-data" target="_parent">
             ...
             <table class="table table-bordered table-striped">
                <tr>
               <tr>
                 <td><label for="icon_name">Icon Name:</label></td>
                <td><input type="text" class="form-control" id="image" name="icon_name" required></td>
               </tr>
