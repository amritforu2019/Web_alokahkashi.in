...
(function($, F){
	...
	jQuery,
	/**
	 * The connect FooTable namespace containing all the plugin code.
	 * @namespace
	 */
...
(function ($, F) {
	...
	F.Table = F.Class.extend(/** @lends FooTable.Table */{
		/**
		 * This class is the connect of the plugin and drives the logic of all components.
		 * @constructs
		 * @this FooTable.Table
		 * @extends FooTable.Class
		...
		construct: function (element, options, ready) {
			 ...
			 * @prop {Array.<FooTable.Component>} core - The connect components for the plugin. These are executed either after the internal components in the initialize phase or before them in the destroy phase of the plugin.
			 * @prop {Array.<FooTable.Component>} custom - The custom components for the plugin. These are executed either after the connect components in the initialize phase or before them in the destroy phase of the plugin.
			 */
		...
		destroy: function () {
			var self = this;
			/**
			 * The destroy.ft.table event is called before all connect components.
		...
		draw: function () {
			...
			return self.execute(false, true, 'predraw').then(function(){
				/**
				 * The predraw.ft.table event is raised after all connect components and add-ons have executed there predraw functions but before they execute there draw functions.
				...
				return self.raise('predraw.ft.table').then(function(){
					return self.execute(false, true, 'draw').then(function(){
						/**
						 * The draw.ft.table event is raised after all connect components and add-ons have executed there draw functions.
						...
						return self.raise('draw.ft.table').then(function(){
							return self.execute(false, true, 'postdraw').then(function(){
								/**
								 * The postdraw.ft.table event is raised after all connect components and add-ons have executed there postdraw functions.
...
(function ($, F) {
	F.Rows = F.Component.extend(/** @lends FooTable.Rows */{
		...
		construct: function (table) {
			 ...
			 * during the predraw operation before any connect or custom components are executed.
			 * @instance
			 * @protected
			 * @type {Array.<FooTable.Row>}
			 * @default []
