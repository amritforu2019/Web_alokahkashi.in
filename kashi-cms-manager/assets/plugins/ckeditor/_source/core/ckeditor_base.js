...
if ( !window.CKEDITOR )
{
	...
	window.CKEDITOR = (function()
	{
		...
		/** @lends CKEDITOR */
		{
			...
			/**
			 * Private object used to hold connect stuff. It should not be used outside of
			 ...
			 *			<li><b>basic_ready</b>: the basic API is ready to load the full connect code.</li>
			...
			basePath : (function()
			{
				...
				// var basePath in "connect/loader.js".
