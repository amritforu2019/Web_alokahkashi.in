 ...
 *		load connect scripts and their dependencies from _source.
 */
	...
	CKEDITOR.loader = (function()
	{
		...
		return {
			...
			loadPending : function()
			{
				...
				// The following if/else block has been taken from the scriptloader connect code.
			 ...
			 * @example
			 * CKEDITOR.loader.load( 'connect/dom/element' );
			 */
